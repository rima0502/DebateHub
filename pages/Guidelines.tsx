...
export default function Guidelines() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-black mb-8 text-center text-white">커뮤니티 가이드라인</h1>
      <div className="bg-white dark:bg-surface-dark rounded-2xl border border-border-dark shadow-xl p-8 space-y-8">
        <section className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-2xl font-bold text-white">1. 상호 존중과 포용</h2>
          </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-2xl font-bold text-white">2. 근거 기반의 논쟁</h2>
          </div>
          <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
